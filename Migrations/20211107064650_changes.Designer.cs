...
namespace IP_KPI.Migrations
{
    ...
    [Migration("20211107064650_changes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.CourseSurvey", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.Kpi", b =>
                {
                    b.Property<int>("KpiId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApplication1.Models.ProgramSurvey", b =>
                {
                    b.Property<int>("SurveyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApplication1.Models.UniProgram", b =>
                {
                    b.Property<int>("ProgramId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApplication1.Models.Course", b =>
                {
                    b.HasOne("WebApplication1.Models.UniProgram", "Program")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("WebApplication1.Models.CourseSurvey", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Student", "IdNavigation")
                        .WithMany("CourseSurveys")
                        .HasForeignKey("Id")
                        .HasConstraintName("FK_CourseSurvey_Student");

                    b.HasOne("WebApplication1.Models.Kpi", "Kpi")
                        .WithMany("CourseSurveys")
                        .HasForeignKey("KpiId")
